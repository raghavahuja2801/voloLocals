    ...
    <div className="flex flex-col min-h-screen bg-gray-50 min-w-screen overflow-x-hidden">
      ...
      <main className="flex-grow px-4 py-12">
        <div className="container mx-auto max-w-7xl">
          <div className={`grid gap-8 ${isContractor ? 'lg:grid-cols-2' : 'place-items-center'}`}>
            {/* Account Information */}
            <div className={`bg-white rounded-xl shadow-lg p-8 ${!isContractor ? 'max-w-xl w-full' : ''}`}>
            ...
            {/* Transaction History - Only for Contractors */}
            {isContractor && (
              <div>
